# python compiler.py ./tests/int_add_sub_shift.asm ../custom_simulation/program.mem

# python compiler.py ./tests/int_mul_div_mod.asm ../custom_simulation/program.mem
